...
video_path = "C:\\Final_year_project\\meinaminute_219158216.mp4.mp4"

# Loading OpenCV Cascade Classifier for Face Detection        
face_cascade = cv2.CascadeClassifier('C:\\Final_year_project\\haarcascade_frontalface_default.xml')

# Loading emotion recognition model and weights 
model = model_from_json(open('C:\\Final_year_project\\fer.json', 'r').read())
model.load_weights('C:\\Final_year_project\\fer.h5') #load weights
...
ffmpeg_path = "C:/ProgramData/chocolatey/lib/ffmpeg/tools/ffmpeg.exe"
